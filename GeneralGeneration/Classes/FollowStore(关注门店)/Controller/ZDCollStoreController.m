...
#import <Masonry.h>
@interface ZDCollStoreController ()<UISearchBarDelegate,UITableViewDelegate,UITableViewDataSource>{
    //页数
    NSInteger currents;
}
//区域label
...
@implementation ZDCollStoreController
...
- (void)viewDidLoad {
    ...
    _allStore.collectBolck = ^(NSString *storeId) {
        _storeListArray = [NSMutableArray array];
        currents = 1;
        [weakSelf loadData];
    };
