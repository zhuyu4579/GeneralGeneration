...
@implementation ZDTodayController
...
-(void)loadData{
    ...
    paraments[@"left"] = _left;
    paraments[@"right"] = _right;
    paraments[@"current"] = [NSString stringWithFormat:@"%ld",(long)current];
    paraments[@"size"] = size;
    NSString *url = [NSString stringWithFormat:@"%@/sysUser/page/orderList",URL];
