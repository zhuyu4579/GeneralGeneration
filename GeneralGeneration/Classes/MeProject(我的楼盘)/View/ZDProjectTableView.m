...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ZDProjectCell *cell = [tableView cellForRowAtIndexPath:indexPath];
    UIViewController *Vc = [UIViewController viewController:self.superview];
    WZHouseDatisController *house = [[WZHouseDatisController alloc] init];
    house.ID = cell.ID;
    [Vc.navigationController pushViewController:house animated:YES];
}
//签约分销
