...
+ (void)translucentWindowCenterCoverContent:(UIView *)contentView
                                  ...
                                  hideBlock:(hideBlock)hide;
/**
 *  半透明遮罩-上方弹窗，添加显示和隐藏的block
 */
+ (void)tranTopCoverFrom:(UIView *)fromView content:(UIView *)contentView animated:(BOOL)animated showBlock:(showBlock)show hideBlock:(hideBlock)hide;
/**
